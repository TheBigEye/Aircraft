...
public class TutorialDisplay extends Display {
	...
	public TutorialDisplay() {
		super(true, new Menu.Builder(false, 6, RelPos.CENTER,
				...
				new StringEntry(Localization.getLocalized("have fun!"), Color.YELLOW), new BlankEntry(),
				...
				new SelectEntry("Furnitures", () -> Game.setDisplay(new CombatTutorial())),
				new SelectEntry("Crafting", () -> Game.setDisplay(new CombatTutorial())),
				new SelectEntry("Potions", () -> Game.setDisplay(new CombatTutorial())),
				new SelectEntry("Farming", () -> Game.setDisplay(new CombatTutorial())),
				new SelectEntry("Mining", () -> Game.setDisplay(new CombatTutorial())),
				new SelectEntry("Bosses", () -> Game.setDisplay(new CombatTutorial())),
				new BlankEntry())
