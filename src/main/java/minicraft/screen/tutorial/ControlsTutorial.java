...
public class ControlsTutorial extends Display {
    ...
    public void render(Screen screen) {
        ...
        Font.drawCentered(
            ...
            screen, Screen.h - 128, Color.GRAY
        ); // Controls
        
        Font.drawCentered(Localization.getLocalized("Options > Change Key bindings"), 
        	screen, Screen.h - 70, Color.GRAY
        ); // Option location
    }
}
