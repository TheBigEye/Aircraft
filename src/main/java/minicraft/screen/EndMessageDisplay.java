...
public class EndMessageDisplay extends Display {
    ...
    String[] array = { "Game Over?", "Win?", "Win??", "Win???", "The End?"
    ...
    public EndMessageDisplay(Player player) {
        ...
        EndMessageDisplay.TITLE = array[random.nextInt(4)];

        entries.add(new StringEntry("No death, no doom,", Color.WHITE));
        entries.add(new StringEntry("no anguish", Color.WHITE));
        entries.add(new StringEntry("can arouse the", Color.WHITE));
        entries.add(new StringEntry("surpassing despai", Color.WHITE));
        entries.add(new StringEntry("which flows from a", Color.WHITE));
        entries.add(new StringEntry("loss of identity", Color.WHITE));
        entries.add(new BlankEntry());
        entries.add(new StringEntry("-H.p Lovecraft", Color.GREEN));
        entries.add(new BlankEntry());
