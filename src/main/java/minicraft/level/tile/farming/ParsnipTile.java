...
public class ParsnipTile extends SkyPlant{
    ...
    public void render(Screen screen, Level level, int x, int y) {
        ...
        screen.render(x + 0, y + 0, 10 + 40 * 32 + icon, 0, 1);
        screen.render(x + 8, y + 0, 10 + 40 * 32 + icon, 0, 1);
        screen.render(x + 0, y + 8, 10 + 40 * 32 + icon, 1, 1);
        screen.render(x + 8, y + 8, 10 + 40 * 32 + icon, 1, 1);
    }
