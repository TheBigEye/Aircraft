...
public enum MapData {
    ...
    BIRCH_FLOOR(Tiles.get("Birch Planks").id, Color.get(1, 145, 79, 14)),
    BIRCH_WALL(Tiles.get("Birch Wall").id, Color.get(1, 122, 67, 12)),
    BIRCH_DOOR(Tiles.get("Birch Door").id, Color.get(1, 122, 72, 23)),
