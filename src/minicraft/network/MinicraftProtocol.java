...
public interface MinicraftProtocol {
    ...
    enum InputType {
        INVALID, PING, USERNAMES, LOGIN, GAME, INIT, LOAD, TILES, ENTITIES, TILE, ENTITY, PLAYER, MOVE, ADD, REMOVE,
        DISCONNECT, SAVE, NOTIFY, INTERACT, PUSH, PICKUP, CHESTIN, CHESTOUT, ADDITEMS, BED, POTION, HURT, DIE, RESPAWN,
        DROP, STAMINA, SHIRT, STOPFISHING;
    ...
    static InputType getInputType(char idxChar) {
        InputType inType;
        int idx = idxChar;
        idx--; // the "-1" is because 1 is added originally so it does not make a null
               // character, which is used to seperate requests.
