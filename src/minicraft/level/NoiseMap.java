...
public class NoiseMap {
     ...
     * 
     * NoiseMap noise = new NoiseMap(w, h); BufferedImage img = new BufferedImage(w,
     * h, BufferedImage.TYPE_INT_RGB); int[] pixels = new int[w * h]; for (int i =
     * 0; i < w * h; i++) { int br = (int)(noise.values[i] * 120 + 128); pixels[i] =
     * br << 16 | br << 8 | br; } img.setRGB(0, 0, w, h, pixels, 0, w);
     * JOptionPane.showMessageDialog(null, null, "The image",
