...
public class RockUpTile extends Tile {
	private ConnectorSprite sprite = new ConnectorSprite(RockUpTile.class, new Sprite(18, 6, 3, 3, 1, 3), new Sprite(21, 8, 2, 2, 1, 3), new Sprite(21, 6, 2, 2, 1, 3))
	{
		public boolean connectsTo(Tile tile, boolean isSide) {
			if(!isSide) return true;
			return tile.connectsToRock;
		}
	};
	private int coalLvl = 0;
	
	protected RockUpTile(String name) {
