...
public class SkyFernTile extends Tile {
	private static Sprite SkyFernSprite = new Sprite(27, 22, 2, 2, 1);
	...
	public boolean tick(Level level, int xt, int yt) {
    	...
    	if (stepped == 0) {
			SkyFernSprite = new Sprite(29, 22, 2, 2, 1);
    	}	
	...
	public void render(Screen screen, Level level, int x, int y) {
		...
		if (stepped >= 8) {
			...
			if (random.nextInt(12) == 9) {
				SkyFernSprite = new Sprite(27, 22, 2, 2, 1);
    		}	
			if (random.nextInt(12) == 1) {
				SkyFernSprite = new Sprite(29, 22, 2, 2, 1);
			}	
			if (random.nextInt(12) == 10) {
				SkyFernSprite = new Sprite(31, 22, 2, 2, 1);
			}
			if (random.nextInt(12) == 3) {
				SkyFernSprite = new Sprite(33, 22, 2, 2, 1);
			}
