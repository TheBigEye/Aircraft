...
public class Game extends Canvas implements Runnable {
	...
	//If changed this, the preferences made and worlds are removed!...Tested by TheBigEye (NOT PROBLEM, PLEASE NOTE MY COMMENT!)
	public static String localGameDir = "/.playminicraft/mods/Aircraft"; //Directory of the game, where worlds and other user preferences are saved! 
...
/**==========================================================// MANAGERIAL VARS AND RUNNING	//========================================================*/
	public static final String NAME = "Aircraft Alpha";  // This is the name on the application window
	
	//If you change the version of the game, you will have to reconfigure the entire "Level" package to be able to load worlds...Tested by TheBigEye (ERRORS OF LOAD!!)
	public static final String VERSION = "2.0.1-dev3";   
...
/**==============================================================// TIME AND TICKS //=================================================================*/	
    ...
    //Please note that editing this may cause some crashes in the EnemyMobs...Tested by TheBigEye (RARELY HAPPENS!)
	public static int tickCount = 0;  // The number of ticks since the beginning of the game day.
	public static int time = 0;  // Facilities time of day / sunlight.
...
/**=============================================================// LEVEL AND PLAYER //================================================================*/	
	...
	static int worldSize = 128; // The size of the world, Remember when you edit this you need to change this same value in LevelGen!!!
...
/**===============================================================// AUTOSAVE AND NOTIFICATIONS	//====================================================*/
	...
	//Never add a value less than 5000. I recommend leaving it at this value to avoid future problems...Tested by TheBigEye (AFFECTS PERFORMANCE)!!
...
/**=======================================================================// CONSTRUSTOR //===========================================================*/
	...
	//Warning....Be careful if you are going to run this!!
	/*
