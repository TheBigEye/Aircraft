...
public class BookData {
	...
	public static final String credits = "Thanks to...\nShylor !!!,  thanks to him there is the playminicraft community.. the one that is unique because of the people who make it up... thanks to him the revive minicraft project is up and running like the server discord.. thanks to you this and everything is possible... thanks. i hope you have read this.\n\nAlice for helping me a lot (help me to solve problems and implement features :), and thanks to her for encouraging me to continue with the development :,) ).\n\nZucc, GC4k, Fusyon, Mr Toad, Terrarianmisha and the entire community for giving me ideas and helping me decide each change without affecting the gameplay (ideas and making decisions).\n\nRiverOaken, for making this epic texture pack, i decided to put you here because you are the owner of Rcraft (the texture pack that you use for the mod), i also made some minor modifications for better details, thanks for making this also possible (Texture pack).\n\nChris and Cristoffer, thanks to you i was able to improve my programming skills and hel me, also without the minicraft plus mod... this would have been possible.. thanks (help and mod base).";
