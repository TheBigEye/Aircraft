...
public class ControlsTutorial extends Display {
	...
	public ControlsTutorial() {
		super(true, new Menu.Builder(false, 6, RelPos.LEFT,
				...
				new BlankEntry(),
				new StringEntry(Localization.getLocalized("You can move with:"), Color.WHITE),
				new BlankEntry(),
				new BlankEntry(),
				new StringEntry(Localization.getLocalized("You can also change the controls to"), Color.WHITE),
				new StringEntry(Localization.getLocalized("your liking in:"), Color.WHITE),
				new BlankEntry(),
				new BlankEntry()			
			)
	...
	public void render(Screen screen) {
		...
		Font.drawCentered(Game.input.getMapping("MOVE-DOWN") + ", " + Game.input.getMapping("MOVE-UP") + ", " + Game.input.getMapping("MOVE-LEFT") + ", " + Game.input.getMapping("MOVE-RIGHT"), screen, Screen.h - 128, Color.GRAY); // Controls
		Font.drawCentered(Localization.getLocalized("Options > Change Key bindings"), screen, Screen.h - 70, Color.GRAY); // Option location
	}
}
