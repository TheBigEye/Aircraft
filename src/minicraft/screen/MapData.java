...
public enum MapData {
    ...
    LIGHT_BLUE_WOOL(Tiles.get("Light Blue Wool").id, Color.get(1, 102, 153, 216)),
    CYAN_WOOL(Tiles.get("Cyan Wool").id, Color.get(1, 76, 127, 153)),
    ORANGE_WOOL(Tiles.get("Orange Wool").id, Color.get(1, 216, 127, 51)),
    
    // Crops in the map
    FARMLAND(Tiles.get("Farmland").id, Color.get(1, 151, 109, 77)),
    WHEAT(Tiles.get("Wheat").id, Color.get(1, 0, 124, 0)),
