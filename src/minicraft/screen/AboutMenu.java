...
public class AboutMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.drawCentered("About Aircraft", screen, 1 * 8, Color.get(-1, 555));
		FontStyle style = new FontStyle(Color.get(-1, 333));
		Font.drawParagraph("Mod by TheBigEye. The objective of this Mod is to expand Minicraft in story, Items, gameplay, and comfort and adaptable to developers. Minicraft was originally made by Markus Persson (Notch) for the ludum dare 22 competition", screen, 4, true, 5 * 8, false, style, 12);
	}
}
