...
public class Recipes {
	...
	public static final ArrayList<Recipe> breweryRecipes = new ArrayList<Recipe>();
	...
	static {
		...
		anvilRecipes.add(new Recipe("Brewery_1", "Wood_50", "gem_10", "coal_100", "iron_20", "glass_20", "Grass Seeds_5", "Bone_1"));
		...
		furnaceRecipes.add(new Recipe("gem_1", "stone_100", "coal_100"));
