...
public class TorchItem extends TileItem {
	...
	private TorchItem(int count) {//Tiles where it can be placed;
		super("Torch", (new Sprite(18, 4, Color.get(-1, 500, 520, 320))), count, "",
				"dirt", "Wood Planks", "Stone Bricks",
				"Wool", "grass", "sand", "hole", "Cloud"
				);
	}
