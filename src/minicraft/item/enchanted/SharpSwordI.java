...
public class SharpSwordI extends Item {
	...
	/*
	 * public int getAttackDamageBonus(Entity e) { if(!payDurability()) return 0;
	 * 
	 * if(e instanceof Mob) { if (SharpI == SharpSwordI.super.getDisplayName()) {
	 * return (level + 1) * 3 + random.nextInt(4 + level * level * 3); // wood: 3-6
	 * damage; gem: 15-66 damage. } return 1; // all other tools do very little
	 * damage to mobs. }
	 * 
	 * return 0; }
	 */
