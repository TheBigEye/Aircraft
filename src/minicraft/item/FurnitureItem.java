...
public class FurnitureItem extends Item {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new FurnitureItem(new Spawner(new Dog())));
		items.add(new FurnitureItem(new Spawner(new BadWolf(1))));
		items.add(new FurnitureItem(new Spawner(new Wolf())));
		...
		items.add(new FurnitureItem(new Brewery()));
